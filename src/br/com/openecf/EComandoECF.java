...
public enum EComandoECF {
     ...
     * IIIIT999.99|IIIIT999.99|IIIIT999.99|....<br><br>
     *
     * <b>Onde:</b><br>
     *
    ...
    ECF_Aliquotas,
    /**
     * Semelhante ao comando ECF.Aliquotas, porém esse comando sempre se
     * comunica com o ECF a fim de ler novamente todas as alíquotas cadastradas.
     */
     ...
     *
     * <b>cTipoAliquota</b> - Tipo da Alíquota , Use "T" para ICMS ou "S" para
     * ISS. Pode ser omitido, nesse caso assume "T".<br>
     *
     * <b>cPosicaoAliquota</b> - Posição de cadastro da Alíquota. Não é aceito
     * em todos os modelos de ECFs, e em alguns outros apenas é aceito em modo
     * de Intervenção. <b>Normalmente esse parâmetro deve ser
     * omitido.</b><br><br>
     *
     * <b>Notas:</b><br>
     *
     ...
     * com o ECF a fim de carregar as formas de pagamentos. Após a carga, elas
     * são transferidas para a memória do ACBrECF.
     */
    ECF_FormasPagamento,
    /**
     * Semelhante ao comando ECF.FormasPagamento, porém esse comando sempre se
     * comunica com o ECF a fim de ler novamente todas as formas de pagamentos
     * cadastradas.
     */
    ...
    /**
     * Programa Forma de Pagamento e retorna índice em que a Forma foi
     * cadastrada.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
     ...
     *
     * <b>bPermitevinculado</b> Opcional - Define se a forma de pagamento esta
     * vinculado ao cupom.<br>
     *
     * <b>cPosicao</b> Opcional - Informa a posicao que deseja inserir a forma
     * de pagamento.
     */
    ECF_ProgramaFormaPagamento,
    /**
     * Acha a forma de pagamento usndo como filtro a descricao da mesma e
     * retorna sua posicao e descricao.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
     ...
     *
     * <b>Nota: </b>Esse comando quando executado a primeira vez, se comunica
     * com o ECF a fim de carregar a tabela de CNFs. Após a carga, elas são
     * transferidas para a memória do ACBrECF.
     */
    ECF_ComprovantesNaoFiscais,
    /**
     * Semelhante ao comando ECF.ComprovantesNaoFiscais, porém esse comando
     * sempre se comunica com o ECF a fim de ler novamente todas as CNFs
     * cadastradas.
     */
    ...
    /**
     * Acha a CNF usndo como filtro a descricao da mesma e retorna sua posicao e
     * descricao.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
     ...
     *
     * <b>Nota: </b>Esse comando quando executado a primeira vez, se comunica
     * com o ECF a fim de carregar a tabela de Unidades. Após a carga, elas são
     * transferidas para a memória do ACBrECF.
     */
    ECF_UnidadesMedida,
    /**
     * Semelhante ao comando ECF.UnidadesMedida, porém esse comando sempre se
     * comunica com o ECF a fim de ler novamente todas as Unidades cadastradas.
     */
    ECF_CarregaUnidadesMedida,
    /**
     * Programa Unidade de Medida e retorna índice em que a UM foi
     * cadastrada.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
    ...
    /**
     * Realiza a sangria no sistema, onde é retirado o dinheiro do
     * caixa.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
    ...
    ECF_Sangria,
    /**
     * Realiza o suprimento no sistema, onde é inserido o dinheiro do
     * caixa.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>cCPF_CNPJ</b> - Parâmetro opcional. Se necessário, informe o CPF/CNPJ
     * do Consumidor.<br>
     *
     * <b>cNOME</b> - Parâmetro opcional. Se necessário, informe o NOME do
     * Consumidor.<br>
     *
     * <b>cENDERECO</b> - Parâmetro opcional. Se necessário, informe o ENDEREÇO
     * do Consumidor.<br>
     *
     * <b>Nota: </b>Nem todos os modelos de ECF fazem uso do parâmetro
     * cCPF_CNPJ, nesse caso o Cupom será aberto, porém o número de
     * identificação do cliente não será impresso.<br>
     *
     * <b>Dica: </b>Para identificar o cliente prefira usar o Rodapé do Cupom,
     * que permite até 8 linhas de texto livre
     */
    ECF_AbreCupom,
    /**
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>cCodigo</b> - Texto com o código do produto, geralmente á aceito até
     * 13 caracteres, alguns ECFs apenas aceitam numéricos no código.<br>
     *
     * <b>cDescricao</b> - Texto com a descrição do Produto vendido. Procure não
     * usar acentos, pois alguns ECFs não aceitam caracteres acentuados. Para
     * imprimir Descrições "grandes" habilite a opção "Descrição Grande" no
     * ACBrMonitor.<br>
     *
     * <b>cAliquotaICMS</b> - Texto com a representação da Alíquota do ICMS. -
     * As alíquotas podem ser informadas em Valor (mesmo sendo texto). Exemplos:
     * "18", "2.46". - Se no ECF existem alíquotas iguais para ICMS e ISS, use o
     * sufixo "T" para informar que a alíquota é do ICMS ou "S" para alíquotas
     * do ISS. Exemplo: "18T" = alíquota de 18% do ICMS; "2.5S" alíquota de 2,5%
     * do ISS - As alíquotas podem ser informadas em índice, de acordo com a
     * Tabela de alíquotas do ECF, nesse caso use a letra "T", seguida da
     * posição da Alíquota: Exemplo: "T01", "T10" - Existem alíquotas internas
     * do ECF para tratar produtos Isentos, nesse caso use: "FF" para
     * Substituição Tributária, "NN" = Não incidência ou "II" = Isento<br>
     *
     * <b>nQtd</b> - Quantidade de Produtos a Vender. Permite valores com até 3
     ...
     * impressão para Inteiros o 2 casas decimais, sempre que possível.<br>
     *
     * <b>nValorUnitario</b> – Preço Unitário do produto vendido. Permite
     * valores com até 3 casas decimais. O ACBr verifica quantas casas decimais
     * existem no valor informado e utiliza o comando apropriado para o ECF,
     * otimizando a impressão para 2 casas decimais, sempre que possível.<br>
     *
     * <b>nDescontoPorc</b> - Parâmetro opcional, Se necessário, informe a
     * Porcentagem de Desconto a aplicar no item Vendido. Dependendo do ECF o
     * valor e porcentagem do Desconto será impresso no Cupom.<br>
     *
     * <b>cUnidade</b> - Parâmetro opcional, Se necessário, informe o Texto com
     * a unidade de medida do Item. Exemplo: "UN", "LT", "MT", "KG", etc<br>
     *
     * <b>cTipoDesc</b> - Parâmetro opcional, Se necessário, informe o tipo de
     * desconto. Pode ser "%" ou "$".<br>
     *
     * <b>cDescAcres</b> - Parâmetro opcional, Se necessário, informe o se será
     * dado desconto ou acréscimo. O valor default é "%D "%(Desconto) mas pode
     * ser passado como "%A "%(Acréscimo) .<br><br>
     *
     * <b>Notas:</b><br>
     *
     * - O ACBr tentará otimizar a impressão ocupando o menor numero de linhas
     * possíveis, de acordo com o tamanho dos parâmetros cCodigo e cDescricao.
     * Espaços a direita de cDescricao são ignorados.<br>
     *
     * - Para evitar "diferenças" entre o seu programa e o impresso no ECF,
     * procure informar os campos nQtd e nValorUnitario já arredondados para o
     * número máximo de casas decimais que você deseja utilizar.
     */
    ECF_VendeItem,
    /**
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>nNumItem</b> - Numero do Item, de acordo com a ordem de impressão no
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>nDescontoAcrescimo</b> - Parâmetro opcional. Para Descontos, informe
     * valores negativos, para acréscimos valores positivos.<br>
     *
     * <b>cMensagemRodape</b> – Parâmetro opcional. Informe até 8 linhas de
     * mensagem a serem impressas no rodapé do cupom. Usado apenas para o ECF
     * DataRegis que não possui o método FechaCupom, nos demais ECFs, se a
     * mensagem for informada nesse momento, ela será armazenada pelo ACBr e
     * utilizada em FechaCupom.
     */
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>cCodFormaPagto</b> - Índice da Forma de pagamento cadastrada no ECF.
     * Para conhecer todas as Formas de pagamento cadastradas e seus respectivos
     * índices, utilize o comando ECF.FormasPagamento.<br>
     *
     * <b>nValor</b> - Valor pago para essa forma de pagamento.<br>
     *
     * <b>cObservacao</b> - Pode ser omitido. Alguns ECFs permitem a impressão
     * de até 2 linhas de observação para cada forma de pagamento.<br>
     *
     * <b>bImprimeVinculado</b> - Pode ser omitido, nesse caso assume "False".
     * Se for informado "True" para este parâmetro, o ACBr apenas verifica se é
     ...
     *
     * <b>cMensagemRodape</b> - Parâmetro opcional. Informe até 8 linhas de
     * mensagem a serem impressas no rodapé do cupom. Se esse parâmetro for
     * omitido aqui, porém foi informado em ECF.SubtotalizaCupom , o texto
     * informado anteriormente será utilizado.<br><br>
     *
     * <b>Notas: </b>Utilize a mensagem no rodapé para identificar o Cliente,
     * (Nome, Documento, Endereço, etc) Este comando só pode ser executado após
     * o Total de Pagamentos (ECF.TotalPago) efetuados com ECF.EfetuaPagamento
     * atingir ou ultrapassar o valor de ECF.SubTotal.
     */
    ECF_FechaCupom,
    /**
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>dDataHora</b> - Data / Hora atual do micro. Parâmetro pode ser
     * omitido. Se dDataHora for informado, o ACBrECF tentará acertar o relógio
     * do ECF (disponível apenas em alguns ECFs), aumentando ou diminuindo o
     * horário no máximo de 5 minutos por dia.<br><br>
     *
     * <b>Nota: </b>Se emitido no mesmo dia fiscal, bloqueia o ECF até as
     * 24:00hs. Se não for emitida no mesmo dia fiscal o ECF ficará bloqueado, e
     * o ACBr retornará o Estado como estRequerZ. Nesse caso será necessário
     * emitir a Redução Z pendente (do dia anterior) para liberar o ECF.<br><br>
     *
     * <b>Cuidado: </b>Apenas comande a Redução Z se o estado do ECF for
     * estRequerZ ou se você deseja realmente bloquear o ECF até a meia-noite
     * (fim de dia).
     */
    ECF_ReducaoZ,
    /**
     ...
     * lado da Hora no rodapé do Cupom Fiscal.
     */
    ECF_HorarioVerao,
    /**
     * Retorna “True” se o ECF arredonda os valores do Total por Item durante a
     * Venda.<br><br>
     *
     * <b>Nota: </b>Na maioria dos ECFs o Arredondamento deve ser programado, o
     * que pode ser feito com o comando ECF.MudaArredondamento Em alguns ECFs o
     * arredondamento é definido de acordo com o comando enviado para a Venda de
     * Item, nesse caso, o ACBr procura usar o Arredondamento sempre que
     * possível. Após o convênio do ICMS 56/94 o arredondamento não é mais
     * permitido, portanto todos os novos ECFs apenas Truncam o Total por Item.
     */
    ECF_Arredonda,
    /**
     ...
     *
     * <li><b>estNaoInicializada</b>, Porta Serial ainda não foi aberta;</li>
     *
     * <li><b>estDesconhecido</b>, Porta aberta, mas estado ainda não
     * definido;</li>
     *
     * <li><b>estLivre</b>, Impressora Livre, sem nenhum cupom aberto pronta
     * para nova venda, Redução Z e Leitura X ok, pode ou não já ter ocorrido 1ª
     * venda no dia...;</li>
     *
     * <li><b>estVenda</b>, Cupom de Venda Aberto com ou sem venda do 1º
     * Item;</li>
     *
     * <li><b>estPagamento</b>, Iniciado Fechamento de Cupom com Formas
     * Pagamento pode ou não ter efetuado o 1º pagamento. Não pode mais vender
     * itens, ou alterar Sub-total;</li>
     *
     * <li><b>estRelatorio</b>, Imprimindo Cupom Fiscal Vinculado ou Relatório
     * Gerencial;</li>
     *
     * <li><b>estBloqueada</b>, Redução Z já emitida, bloqueada até as
     * 00:00;</li>
     *
     * <li><b>estRequerZ</b>, Redução Z do dia anterior ainda não foi emitida.
     * Emitir agora;</li>
     *
     * <li><b>estRequerX</b>, Esta impressora requer Leitura X todo inicio de
     * dia. É necessário imprimir uma Leitura X para poder vender.</li>
     */
    ECF_Estado,
    /**
     ...
     * <b>Parâmetros:</b><br>
     *
     * <b>bHorarioVerao</b> - Um booleano, passar "True" para ativar o horário
     * de verão, ou passar "False" para desativar.
     */
    ECF_MudaHorarioVerao,
    /**
     * Método que muda o tipo de arredondamento de casas decimais no
     * ECF.<br><br>
     *
     * <b>Parâmetros:</b><br>
     *
     * <b>bArredonda</b> - Um booleano, passar "True" para ativar o
     * arredondamento em 2 casas , ou passar "False" para truncar o número em 2
     * casas decimais.
     */
    ECF_MudaArredondamento,
    /**
     * - Verifica se existe algum relatório Gerencial ou Vinculado aberto, se
     * for o caso, fecha-o.<br>
     *
    ...
    ECF_FechaRelatorio,
    /**
     * Método que emite a leitura de memória fiscal completa ou
     * simplificada.<br><br>
     *
    ...
    /**
     * Método que emite a leitura de memória fiscal completa ou simplificada
     * pela serial.<br><br>
     *
     ...
     *
     * <b>nTimeOut</b> Opcinal pode-se passar um tempo em milissegundos para
     * esperar.
     */
    ECF_EnviaComando,
    /**
    ...
    /**
     * Método que gerar o arquivo espelho da leitura de memória fiscal
     * completa.<br><br>
     *
     * <b>Parâmetros:</b> Pode passar duas datas ou duas reducoes.<br>
     *
    ...
    /**
     * Método que gerar o arquivo espelho da leitura de memória fiscal completa
     * no layout do ato cotepe 17/04.<br><br>
     *
     * <b>Parâmetros:</b> Pode passar duas datas ou duas reducoes.<br>
     *
     * <b>dDt.Inicial</b> A data inicial do relatorio.<br>
    ...
    /**
     * Método que gerar o arquivo memoria de fita detalhe no layout do ato
     * cotepe 17/04.<br><br>
     *
     * <b>Parâmetros:</b> Pode passar duas datas ou duas reducoes.<br>
     *
